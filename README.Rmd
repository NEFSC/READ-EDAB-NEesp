...
cat(
  badger::badge_devel("NOAA-EDAB/NEesp", "blue"),
  badger::badge_last_commit("NOAA-EDAB/NEesp"),
  badger::badge_bioc_download("clusterProfiler", "total", "yellow"),
  badger::badge_code_size("NOAA-EDAB/NEesp"),
  badger::badge_github_actions("NOAA-EDAB/NEesp")
)
```
