...
read_files <- files[stringr::str_detect(files, "catch_wave") %>% which()]
...
write.csv(big_data, file = here::here("data-raw/MRIP", "all_MRIP_catch_wave.csv"))

rec_catch_wave <- read.csv(here::here("data-raw/MRIP", "all_MRIP_catch_wave.csv")) %>%
...
usethis::use_data(rec_catch_wave, overwrite = TRUE)
