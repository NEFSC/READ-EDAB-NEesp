...
tab <- ggpubr::ggtexttable(rpt_card_time, 
                           rows = NULL,
                           cols = 1:length(colnames(rpt_card_time)),
...
rpt_card_time <- sapply(rpt_card_time, stringr::str_remove_all, pattern = ", high")
rpt_card_time <- sapply(rpt_card_time, stringr::str_remove_all, pattern = ", neutral")
rpt_card_time <- sapply(rpt_card_time, stringr::str_remove_all, pattern = ", low")
