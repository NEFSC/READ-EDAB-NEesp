...
#### Deploy the status check to Github
...
#### Create an issue if the status check showed errors
...
#### Force the workflow to break if the status check showed errors
