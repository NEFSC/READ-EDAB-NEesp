...
knitr::include_graphics("../images/data curation.png", dpi = 300)
```
...
knitr::include_graphics("../images/function creation.png", dpi = 200)
```
...
knitr::include_graphics("../images/report template.png", dpi = 200)
```
...
knitr::include_graphics("../images/github actions.png", dpi = 200)
```
