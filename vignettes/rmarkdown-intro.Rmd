...
The examples above are minimal examples. More complex reports can be created with more parameters and more rendering options. 

### Bookdown

The [`bookdown` package](https://bookdown.org/yihui/bookdown/) offers many extensions of the functionality of R Markdown. Most notably, documents created with `bookdown` are saved in a series of separate files ("chapters" or "sections"), allowing long reports to be broken up into more manageable chunks. Sections can easily be inserted and removed from the report. 
