...
NEesp::save_data(survey_data, name = "survey_data")

NEesp::save_data(cond_data, name = "cond_data")

NEesp::save_data(diet_data, name = "diet_data")

NEesp::save_data(asmt_data, name = "asmt_data")

NEesp::save_data(asmt_sum_data, name = "asmt_sum_data")

NEesp::save_data(swept_data, name = "swept_data")

NEesp::save_data(rec_data, name = "rec_data")

NEesp::save_data(com_data, name = "com_data")

NEesp::save_data(hab_data, name = "hab_data")

NEesp::save_data(climate_data, name = "climate_data")

NEesp::save_data(risk_data, name = "risk_data")

NEesp::save_data(risk_year_hist_data, name = "risk_year_hist_data")

NEesp::save_data(risk_year_value_data, name = "risk_year_value_data")

NEesp::save_data(risk_species_data, name = "risk_species_data")
```
