...
```{r, comp-risk-plot, fig.cap = paste(species, "comprehensive risk assessment")}
ggplot2::ggplot(
  risk_data,
  ggplot2::aes(
...
```{r, year-risk-hist, fig.cap = paste(species, "normalized rank of magnitude of change compared to historical value by year")}
...
```{r, year-risk-value, fig.cap = paste(species, "normalized rank of value in each year")}
...
```{r, stock-risk,  fig.cap = paste(species, "within-stock risk over time")}
